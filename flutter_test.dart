...
void main() {
  ...
  group('RSA and AES Encryption/Decryption', () {
    test('Generate AES with Signature', () {
      try {
        const plaintext = '{"Code":"172","Amount":100.0,"Currency":"INR"}';
        ...
        logger.d(
          'Encrypted AES: ${encryptedAES.$1}',
        ); // Add print for debugging

        logger.d(
          'Singature AES:  ${encryptedAES.$3}',
        ); // Add print for debugging

        // Decrypt with AES
        final decryptedAES = Crypto.decryptWithAES(
          key,
          encryptedAES.$1,
          encryptedAES.$2,
        );
        ...
        bool isVerified = Crypto.fromBase64PublicKey(
          serverPublicKey,
    ...
    test('Test RSA Encrypt with Public Key and Decrypt with Private Key', () {
      try {
        ...
        final encryptedMessage = Crypto.fromBase64PublicKey(
          serverPublicKey,
        ...
        final decrypted = Crypto.fromBase64PrivateKey(
          serverPrivateKey,
    ...
    test('Test AES Decryption Failure with Wrong Key', () {
      ...
      try {
        ...
        logger.e(
          'Decryption failed as expected with wrong key: $key',
          error: e,
        );
